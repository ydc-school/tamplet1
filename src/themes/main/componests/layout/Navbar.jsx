...
export default function Navbar() {
  ...
  return (
    <div ref={menuRef}>
      <nav className="bg-heritage-navy dark:bg-primary-main text-on-primary dark:text-inverse-on-surface docked full-width top sticky z-50 border-b-2 border-academic-gold shadow-md transition-all duration-300 ease-in-out">
