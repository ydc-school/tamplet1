...
export default function Footer() {
  ...
  return (
    <footer className="bg-heritage-navy dark:bg-primary-main text-on-primary  dark:text-inverse-on-surface  full-width py-12 border-t border-outline-variant transition-opacity opacity-90 hover:opacity-100 font-body-md ">
