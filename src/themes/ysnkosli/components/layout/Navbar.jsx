      ...
      <header className="w-full relative z-50" ref={menuRef}>
        ...
        <nav className="bg-deep-maroon text-white shadow-sm flex flex-col w-full text-xs">
          <div className="max-w-7xl flex-col sm:flex-row gap-4  py-8  mx-auto w-full px-6 sm:px-6  sm:py-2 flex sm:justify-center justify-between items-center font-medium tracking-wide">
            <div className="flex gap-0.5 sm:gap-6 items-center">
              ...
              <Link href="https://app.cloudpano.com/tours/LZymJhFtz" className="flex items-center gap-2 hover:bg-white/10 transition-colors py-1 px-2 rounded">
            ...
            <div className="flex gap-6   items-center">
              ...
              <div className="flex gap-4 ml-4 border-l px-8 border-white/20 pl-4 items-center text-white w-screen sm:w-auto justify-between sm:justify-center ">
                {/* Facebook */}
                <a href={'https://www.facebook.com/yaduvanshigroup/'} target="_blank" rel="noopener noreferrer" className="hover:text-amber-400  transition-colors">
                  <svg className="sm:w-5 h-6 w-6   sm:h-5 fill-current" viewBox="0 0 24 24">
                ...
                {/* Instagram */}
                <a href={'https://www.instagram.com/yaduvanshi_grp_of_institutions/?hl=en'} target="_blank" rel="noopener noreferrer" className="hover:text-amber-400 transition-colors">
                  <svg className="sm:w-5 h-6 w-6   sm:h-5  fill-current" viewBox="0 0 24 24">
                ...
                {/* YouTube */}
                <a href={"https://www.youtube.com/channel/UCNXv7DakSohb4XYGXwpoLKg?view_as=su"} target="_blank" rel="noopener noreferrer" className="hover:text-amber-400 transition-colors">
                  <svg className="sm:w-5 h-6 w-6   sm:h-5  fill-current" viewBox="0 0 24 24">
        ...
        <nav className={` bg-[#6d001d] text-white w-full transition-all duration-300 ${scrolled ? "fixed top-0 left-0 shadow-md z-50" : "relative"}`}>
          <div className="max-w-7xl mx-auto flex justify-between items-center w-full px-6">
            ...
            <div className="hidden lg:flex items-center gap-6 text-xs font-bold uppercase tracking-widest py-3.5 ml-auto">
              ...
              <Link href="/contact-us" className="hover:text-amber-400 whitespace-nowrap transition-colors">contact-us</Link>
            </div>
          </div>
        </nav>
        ...
        <div className={`fixed inset-y-0 right-0 w-full max-w-sm bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out md:hidden flex flex-col ${open ? "translate-x-0" : "translate-x-full"}`}>
          ...
          <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-1.5">
            ...
            <Link href="/contact-us" onClick={handleMobileLink} className="px-4 py-3 rounded-md font-bold text-xs uppercase tracking-wider text-gray-800 hover:bg-gray-50 hover:text-[#6d001d] transition-colors border-l-4 border-transparent">
              contact-us
            </Link>
          </div>
