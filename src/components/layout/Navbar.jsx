    ...
    <>
      <header className="w-full relative z-50" ref={menuRef}>
        <nav className="bg-deep-maroon text-white shadow-sm flex flex-col w-full text-xs">
          <div className="max-w-7xl mx-auto w-full px-6 py-2 flex justify-between flex-wrap sm:flex-nowrap gap-4 items-center font-medium tracking-wide  ">
            <div className="flex gap-6 text-xl text-center sm:text-xl flex-wrap sm:flex-nowrap items-center">
              <Link href="#" className="flex w-full text-center sm:w-auto items-center justify-center gap-2 hover:bg-white/10 transition-colors py-1 px-2 rounded">
              ...
              <Link href="https://admin.yaduvanshigroup.edu.in/" className="flex w-full text-center sm:w-auto items-center justify-center gap-2 hover:bg-white/10 transition-colors py-1 px-2 rounded">
                <span className="material-symbols-outlined text-[18px]">newspaper</span>
                Admin Portal
              </Link>
            </div>

            <div className="flex  w-full gap-42 items-center">


             
              <div className="flex gap-4 ml-4 border-l justify-center  w-full border-white/20 pl-4 items-center text-white">
                {/* Facebook */}
