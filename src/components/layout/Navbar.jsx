    ...
    <>
      <header className="w-full relative z-50" ref={menuRef}>
        <nav className="bg-deep-maroon text-white shadow-sm flex flex-col w-full text-xs">
          <div className="max-w-7xl mx-auto w-full px-6 py-6 flex justify-between flex-wrap sm:flex-nowrap gap-9 items-center font-medium tracking-wide  ">
            <div className="flex flex-wrap items-center gap-1 text-center text-sm sm:flex-nowrap sm:text-base">
              <Link
                href="#"
                className="flex w-full items-center justify-center gap-2 rounded px-2 py-1 transition-colors hover:bg-white/10 sm:w-auto"
              >
              ...
              <Link
                href="https://admin.yaduvanshigroup.edu.in/"
                className="flex w-full items-center justify-center gap-2 rounded px-2 py-1 transition-colors hover:bg-white/10 sm:w-auto"
              >
            ...
            <div className="flex sm:w-auto w-full  items-center">
              ...
              <div className="flex  w-full items-center justify-between border-l border-white/20  pl-4 text-white sm:w-auto sm:justify-start gap-8">

                {/* Facebook (Note: URL variable says twitterUrl, changed label context to match your SVG) */}
                <a
                  href={twitterUrl}
                  target="_blank"
                ...
                >
                  <svg className="h-9 w-9 fill-current sm:h-5 sm:w-5" viewBox="0 0 24 24">
