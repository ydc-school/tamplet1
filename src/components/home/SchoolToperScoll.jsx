                    ...
                    <div className="flex">
                        <div className="flex">
                            {cardData?.map((card, index) => (
                                <div key={index} className="w-72 mx-4 h-[20rem] relative group hover:scale-95 flex-shrink-0 transition-transform duration-500 ease-in-out hover:rotate-x-180 ">
