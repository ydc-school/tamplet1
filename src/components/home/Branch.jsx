    ...
    return (
        <>
            <section className="py-section-padding bg-surface-container-low" id="schools">
                <div className="max-w-container-max mx-auto px-gutter mb-8 flex flex-col items-center text-centermb-stack-lg">
                    <h2 className="font-headline-lg text-headline-lg text-heritage-navy ">HIGHER EDUCATION CAMPUSES
                    </h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-gutter">
                        ...
                        <div className="bg-white group overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
                            ...
                            <div className="p-4 border-t-4 border-heritage-navy">
                                <p className="font-label-caps text-label-caps text-heritage-navy">Yaduvanshi College of Engg. & Tech., Narnaul (B.Tech., M.Tech.)
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white group overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
                            ...
                            <div className="p-4 border-t-4 border-heritage-navy">
                                <p className="font-label-caps text-label-caps text-heritage-navy">Yaduvandhi Degree College, Mahendergarh (UG, PG)
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white group overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
                            ...
                            <div className="p-4 border-t-4 border-heritage-navy">
                                <p className="font-label-caps text-label-caps text-heritage-navy">Yaduvanshi College of Education, Mahendergargh (B.Ed., M.Ed.)
                                </p>
                            </div>
                        </div>
            ...
            <section className="py-section-padding bg-surface-container-low" id="schools">
                <div className="max-w-container-max mx-auto px-gutter mb-8 flex flex-col items-center text-centermb-stack-lg">
                    <h2 className="font-headline-lg text-headline-lg text-heritage-navy ">SCHOOL CAMPUSES
                    </h2>
                    <div className="w-48 h-1 bg-academic-gold"></div>
                </div>
                <div className="max-w-container-max mx-auto px-gutter">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-gutter">
                        ...
                        <div className="bg-white group overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
                            ...
                            <div className="p-4 border-t-4 border-heritage-navy">
                                <p className="font-label-caps text-label-caps text-heritage-navy">Yaduvanshi Shiksha Niketan, MahenderGarh
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white group overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
                            ...
                            <div className="p-4 border-t-4 border-heritage-navy">
                                <p className="font-label-caps text-label-caps text-heritage-navy">Yaduvanshi Shiksha Niketan, Narnaul
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white group overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
                            ...
                            <div className="p-4 border-t-4 border-heritage-navy">
                                <p className="font-label-caps text-label-caps text-heritage-navy">Yaduvanshi Shiksha Niketan, Rewari
                                </p>
                            </div>
                        </div>
