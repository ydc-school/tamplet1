...
const IMG_BASE = process.env.NEXT_PUBLIC_BACKEND_URL + "/uploads/"; // adjust path
...
export default function BlogsListPage() {
  ...
  return (
    <>
      <style>{`
        .bl-root { min-height: 100vh; background: #071020; font-family: 'Source Sans 3', sans-serif; position: relative; overflow: hidden; }
        ...
        /* Hero */
        .bl-hero { width: 100%; background: linear-gradient(160deg, #0c1e3a 0%, #071020 100%); border-bottom: 1px solid rgba(196,160,72,0.12); padding: 110px 24px 48px; position: relative; z-index: 1; overflow: hidden; }
        ...
        .bl-title { font-family: 'Playfair Display', serif; font-size: clamp(28px, 4vw, 46px); font-weight: 800; color: #f0e6c8; line-height: 1.2; margin: 0; }
        ...
        .bl-search { background: rgba(255,255,255,0.04); border: 1px solid rgba(196,160,72,0.15); border-radius: 2px; color: #c5d8e8; font-family: inherit; font-size: 13px; padding: 9px 14px 9px 36px; width: 240px; outline: none; transition: border-color 0.2s; }
        ...
        /* Card */
        .bl-card { background: linear-gradient(145deg, #0f2044 0%, #091830 100%); border: 1px solid rgba(196,160,72,0.12); border-radius: 4px; overflow: hidden; display: flex; flex-direction: column; text-decoration: none; cursor: pointer; transition: border-color 0.22s, transform 0.22s; }
        ...
        .bl-img-placeholder { width: 100%; height: 180px; background: linear-gradient(135deg, #0c1e3a 0%, #071020 100%); display: flex; align-items: center; justify-content: center; border-bottom: 1px solid rgba(196,160,72,0.08); }
        ...
        .bl-card-title { font-family: 'Playfair Display', serif; font-size: 17px; font-weight: 700; color: #f0e6c8; line-height: 1.35; margin: 0; flex: 1; }
        ...
        .bl-author-name { font-size: 11px; font-weight: 600; color: #c5d8e8; display: block; }
        ...
        .bl-featured-badge { font-size: 9px; font-weight: 700; letter-spacing: 0.18em; text-transform: uppercase; color: #071020; background: #c4a048; border-radius: 2px; padding: 3px 8px; display: inline-block; margin-bottom: 4px; }
        ...
        .bl-err-title { font-family: 'Playfair Display', serif; font-size: 24px; font-weight: 700; color: #f0e6c8; margin-bottom: 8px; }
        .bl-err-msg { font-size: 14px; color: #3a5a7a; margin-bottom: 16px; }
        .bl-retry-btn { display: inline-flex; align-items: center; gap: 7px; background: #c4a048; color: #071020; font-size: 12px; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; padding: 11px 24px; border: none; border-radius: 2px; cursor: pointer; font-family: inherit; }
        .bl-retry-btn:hover { background: #e0c060; }
        .bl-empty { text-align: center; padding: 60px 24px; grid-column: 1 / -1; }
        .bl-empty-title { font-family: 'Playfair Display', serif; font-size: 20px; color: #f0e6c8; margin-bottom: 8px; }
        ...
        .bl-page-btn.active { background: #c4a048; border-color: #c4a048; color: #071020; }
              ...
              <div className="bl-grid">
                ...
                {featured && (
                  <Link href={`/blogs/${featured.Id}`} className="bl-card bl-featured">
                    <div>
                      {featured.Image
                        ? <img className="bl-card-img" src={`/uploads/${featured.Image}`} alt={featured.Title} />
                        : (
                ...
                {rest.map((b) => (
                  <Link key={b.Id} href={`/blogs/${b.Id}`} className="bl-card">
                    {b.Image
                      ? <img className="bl-card-img" src={`/uploads/${b.Image}`} alt={b.Title} />
                      : (
                        <div className="bl-img-placeholder">
