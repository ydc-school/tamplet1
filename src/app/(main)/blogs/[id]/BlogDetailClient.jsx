          ...
          <>
            ...
            <div style={{ position: "relative" }}>
              {blog.Image ? (
                ...
                <>
                  <div>
                    <svg width="64" height="64" fill="none" viewBox="0 0 24 24" stroke="#c4a048" strokeWidth={0.8}>
...
function ShareRow() {
  ...
  return (
    <div>
      ...
      <span style={{ display: copied ? "inline" : "none" }}>✓ Copied!</span>
    </div>
  );
}
